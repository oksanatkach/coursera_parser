    ...
    def extract_features(tokens, buffer, stack, arcs):
        ...
        if stack:
            ...
            if FeatureExtractor._check_informative(token['ctag'], True):
                result.append('STK_0_POSTAG_' + token['ctag'])
            ...
            if len(stack) > 1:
                ...
                if FeatureExtractor._check_informative(token['ctag'], True):
                    result.append('STK_1_POSTAG_' + token['ctag'])
        ...
        if buffer:
            ...
            if FeatureExtractor._check_informative(token['ctag'], True):
                result.append('BUF_0_POSTAG_' + token['ctag'])
            ...
            if FeatureExtractor._check_informative(token['ctag'], True):
                result.append('BUF_1_POSTAG_' + token['ctag'])
            ...
            #    token = tokens[buffer_idx2]
                ...
                #if FeatureExtractor._check_informative(token['ctag'], True):
                #    result.append('BUF_2_POSTAG_' + token['ctag'])
            ...
            #    token = tokens[buffer_idx3]
                ...
                #if FeatureExtractor._check_informative(token['ctag'], True):
                #    result.append('BUF_3_POSTAG_' + token['ctag'])
